...
class XaiChatCompletionInteraction implements InteractionUtils {
  private request: archestraApiTypes.XaiChatCompletionRequest;
  private response: archestraApiTypes.XaiChatCompletionResponse;
  modelName: string;

  constructor(interaction: Interaction) {
    this.request =
      interaction.request as archestraApiTypes.XaiChatCompletionRequest;
    this.response =
      interaction.response as archestraApiTypes.XaiChatCompletionResponse;
  ...
  private mapToUiMessage(
    message:
      | archestraApiTypes.XaiChatCompletionRequest["messages"][number]
      | archestraApiTypes.XaiChatCompletionResponse["choices"][number]["message"],
  ): PartialUIMessage {
    ...
    const xaiRoleToUIMessageRoleMap: Record<
      archestraApiTypes.XaiChatCompletionRequest["messages"][number]["role"],
    ...
    return {
      role: xaiRoleToUIMessageRoleMap[role],
      parts,
    };
  }
