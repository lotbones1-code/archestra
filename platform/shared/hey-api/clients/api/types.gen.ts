...
export type GetChatApiKeysResponses = {
    ...
    200: Array<{
        ...
        name: string;
        provider: 'anthropic' | 'cerebras' | 'gemini' | 'openai' | 'vllm' | 'ollama' | 'xai';
...
export type CreateChatConversationData = {
    body: {
        ...
        title?: string | null;
        selectedModel?: string;
        selectedProvider?: 'anthropic' | 'cerebras' | 'gemini' | 'openai' | 'vllm' | 'ollama' | 'xai';
        chatApiKeyId?: string | null;
    };
    path?: never;
    query?: never;
...
export type GetOptimizationRulesResponses = {
    ...
    200: Array<{
        ...
        provider: 'openai' | 'gemini' | 'anthropic' | 'cerebras' | 'vllm' | 'ollama' | 'xai';
        targetModel: string;
        enabled: boolean;
        createdAt: string;
        updatedAt: string;
